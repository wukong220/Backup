...
FixStyle(vforce,FixVForce)

#else

#ifndef LMP_FIX_VFORCE_H
#define LMP_FIX_VFORCE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixVForce : public Fix {
 public:
  FixVForce(class LAMMPS *, int, char **);
  ~FixVForce();
  int setmask();
  void init();
  void setup(int);
