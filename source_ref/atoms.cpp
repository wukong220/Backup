...
#define Type_wall 3
#define Type_chain 4
#define N_atomtype	4	//粒子类型
#define N_bondtype	1	//键类型 
#define N_angletype	1	//角类型

//const double Den_active=0.1;	//活性粒子面密度 //实际密度的一半 
//const double Den_passive=0.1;		//普通分子数密度
...
//const double Boundary_x=100.0;		//盒子中心边界的距离 
...
/*			for(ib=0;ib<ia;ib++)
			...
			if(t0==0)  break;		//若t0==0，说明第runt个粒子符合条件，退出检测循环
		}
	}*/
